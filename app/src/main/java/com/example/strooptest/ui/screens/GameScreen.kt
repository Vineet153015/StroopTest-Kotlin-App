...
//        ) {
//            // Timer and progress with smooth updates
//            Row(
//                modifier = Modifier
//                    .fillMaxWidth()
...
//            ) {
//                // ✅ Smooth question number transition
//                AnimatedContent(
//                    targetState = "$questionNumber/$totalQuestions",
//                    transitionSpec = {
...
//            Spacer(modifier = Modifier.height(60.dp))
//
//            // ✅ Smooth instruction transitions
//            AnimatedContent(
...
//                if (!listening) {
//                    Text(
//                        text = "Tap the microphone and say the COLOR of the text",
