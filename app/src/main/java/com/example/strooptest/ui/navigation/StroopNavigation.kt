...
fun StroopNavigation(
    ...
    val gazeDetectionState by viewModel.gazeDetectionState
            ...
            "game" -> {
                ...
                if (gameState is GameState.Playing) {
                    GameScreen(
                        ...
                        gameSessionId = gazeDetectionState.sessionId,
                        onGazeDetected = { gazeData -> viewModel.onGazeDetected(gazeData) },
                        getCurrentGameContext = { viewModel.getCurrentGameContext() },
                        isGazeDetectionEnabled = gazeDetectionState.isEnabled
                    )
                }
            }
            "score" -> {
